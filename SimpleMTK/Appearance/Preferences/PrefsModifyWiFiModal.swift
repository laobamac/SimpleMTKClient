...
private extension String {
    ...
    static let wpa1_2_Personal = NSLocalizedString(MTK80211_SECURITY_WPA_PERSONAL_MIXED.description)
    static let wpa2Personal = NSLocalizedString(MTK80211_SECURITY_WPA2_PERSONAL.description)
    static let wpa1_2_Enterprise = NSLocalizedString(MTK80211_SECURITY_WPA_ENTERPRISE_MIXED.description)
