...
extension WiFiConfigWindow {
    ...
    private func joinWiFi() {
        ...
        switch securityPop.title {
        case .none:
            network.auth.security = MTK80211_SECURITY_NONE
        case .wpa_1_2_Personal:
            network.auth.security = MTK80211_SECURITY_WPA_PERSONAL_MIXED
        case .wpaPersonal:
            network.auth.security = MTK80211_SECURITY_WPA_PERSONAL
        case .wpa2Personal:
            network.auth.security = MTK80211_SECURITY_WPA2_PERSONAL
        case .wpa_1_2_Enterprise:
            network.auth.security = MTK80211_SECURITY_WPA_ENTERPRISE_MIXED
        case .wpa2Enterprise:
            network.auth.security = MTK80211_SECURITY_WPA2_ENTERPRISE
        default:
            network.auth.security = MTK80211_SECURITY_UNKNOWN
        }
...
private extension String {
    ...
    static let none = NSLocalizedString(MTK80211_SECURITY_NONE.description)
    static let wep = NSLocalizedString(MTK80211_SECURITY_WEP.description)
    static let wpa_1_2_Personal = NSLocalizedString(MTK80211_SECURITY_WPA_PERSONAL_MIXED.description)
    static let wpa_2_3_Personal = NSLocalizedString("WPA2/WPA3 Personal")
    static let wpaPersonal = NSLocalizedString(MTK80211_SECURITY_WPA_PERSONAL.description)
    static let wpa2Personal = NSLocalizedString(MTK80211_SECURITY_WPA2_PERSONAL.description)
    static let wpa3Personal = NSLocalizedString(MTK80211_SECURITY_WPA3_PERSONAL.description)
    static let dynamicWEP = NSLocalizedString(MTK80211_SECURITY_DYNAMIC_WEP.description)
    static let wpa_1_2_Enterprise = NSLocalizedString(MTK80211_SECURITY_WPA_ENTERPRISE_MIXED.description)
    static let wpa_2_3_Enterprise = NSLocalizedString("WPA2/WPA3 Enterprise")
    static let wpa2Enterprise = NSLocalizedString(MTK80211_SECURITY_WPA2_ENTERPRISE.description)
    static let wpa3Enterprise = NSLocalizedString(MTK80211_SECURITY_WPA3_ENTERPRISE.description)
