...
final class NetworkManager {
    ...
    static func connect(networkInfo: NetworkInfo, saveNetwork: Bool = false,
        ...
        DispatchQueue.global().async {
            ...
            guard networkInfo.auth.security != MTK80211_SECURITY_NONE,
    ...
    static func getSecurityType(_ info: ioctl_network_info) -> mtk80211_security {
        if info.supported_rsnprotos & MTK80211_PROTO_RSN.rawValue != 0 {
            // WPA2
            if info.rsn_akms & MTK80211_AKM_8021X.rawValue != 0 {
                if info.supported_rsnprotos & MTK80211_PROTO_WPA.rawValue != 0 {
                    return MTK80211_SECURITY_WPA_ENTERPRISE_MIXED
                }
                return MTK80211_SECURITY_WPA2_ENTERPRISE
            } else if info.rsn_akms & MTK80211_AKM_PSK.rawValue != 0 {
                if info.supported_rsnprotos & MTK80211_PROTO_WPA.rawValue != 0 {
                    return MTK80211_SECURITY_WPA_PERSONAL_MIXED
                }
                return MTK80211_SECURITY_WPA2_PERSONAL
            } else if info.rsn_akms & MTK80211_AKM_SHA256_8021X.rawValue != 0 {
                return MTK80211_SECURITY_WPA2_ENTERPRISE
            } else if info.rsn_akms & MTK80211_AKM_SHA256_PSK.rawValue != 0 {
                return MTK80211_SECURITY_PERSONAL
            }
        } else if info.supported_rsnprotos & MTK80211_PROTO_WPA.rawValue != 0 {
            // WPA
            if info.rsn_akms & MTK80211_AKM_8021X.rawValue != 0 {
                return MTK80211_SECURITY_WPA_ENTERPRISE
            } else if info.rsn_akms & MTK80211_AKM_PSK.rawValue != 0 {
                return MTK80211_SECURITY_WPA_PERSONAL
            } else if info.rsn_akms & MTK80211_AKM_SHA256_8021X.rawValue != 0 {
                return MTK80211_SECURITY_WPA_ENTERPRISE
            } else if info.rsn_akms & MTK80211_AKM_SHA256_PSK.rawValue != 0 {
                return MTK80211_SECURITY_ENTERPRISE
            }
        } else if info.supported_rsnprotos == 0 {
            return MTK80211_SECURITY_NONE
        }
        return MTK80211_SECURITY_UNKNOWN
    }
